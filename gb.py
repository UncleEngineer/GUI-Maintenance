...
class Report(object):
	...
	def createDocument(self, canvas, doc):
		...
		header_text = "<font name='chsFont'><b>บริษัท ก.บ. จำกัด</b></font>"
...
def synctofirebase():
	pass
	# datatofirebase = selectdata()
	# print(datatofirebase)

	# dt = datetime.now().strftime('%Y%m%d_%H%M%S')
	# print(dt)
	# url = 'https://mh.firebaseio.com/'
	# messenger = firebase.FirebaseApplication(url)

	# #upload to firebase
	# result = messenger.put('/sparepart',dt,datatofirebase)
	# print(result)
...
SPAD_sup = ['บริษัท ก.บ. จำกัด ','Supplier 1','Supplier 2','Supplier 3','Supplier 4','Supplier 5']
